  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid  md:grid-cols-3 gap-4">
        <InfoTile title="Income" total={(stats.totalIncome / 100).toFixed(2)} variant='success'/>
        <InfoTile title="Expenses" total={(stats.totalExpenses / 100).toFixed(2)} variant='danger'/>
